...
module "alb" {
  ...
  vpc_id                     = module.vpc.vpc_id
  patient_service_id         = module.ecs.patient_service_id  # Pass the ECS patient service ID
  appointment_service_id     = module.ecs.appointment_service_id  # Pass the ECS appointment service ID
}
